...
public class CustomerLoginPage extends TestBase {
	...
	public WithdrawalPage CustomerLogin(String username)
	{
	...
	public TransactionPage CustomerLogin1(String username)
	{
		Customer_Login.click();
		WebElement dropdownElement = driver.findElement(By.xpath(prop.getProperty("dropdown")));
	...
	public ViewCustomersPage ManagerLogin2()
	{
		Manager_Login.click();
		return new ViewCustomersPage();
	}
