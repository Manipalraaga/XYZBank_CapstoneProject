...
public class WithdrawalPage extends TestBase{
	...
	public WithdrawalPage Deposit(int amount)
	{
	...
	public WithdrawalPage Withdraw(int amount) throws InterruptedException
	{
	...
	public WithdrawalPage navigateToWithdrawalPage1() {
